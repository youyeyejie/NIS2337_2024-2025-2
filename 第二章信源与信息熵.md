...
- **结论**：
    ...
    4. 当 \(L \to \infty\) 时，有
        ...
        \] 其中\(H_{\infty}(\vec{X})\)是极限熵
        - **证明**：
            \[
            \begin{align*}
            H_{L + k}(\vec{X})&=\frac{1}{L + k}[H(X_1,X_2,\cdots,X_{L - 1})+H(X_L|X_1X_2\cdots X_{L - 1})+\cdots + H(X_{L + k}|X_1X_2\cdots X_{L + k - 1})]\\
            &\leq\frac{1}{L + k}[H(X_1,X_2,\cdots,X_{L - 1})+H(X_L|X_1X_2\cdots X_{L - 1})+H(X_L|X_1X_2,\cdots,X_{L - 1})+\cdots + H(X_L|X_1\cdots X_{L - 1})]\\
