...
2. \(X_1 \to X_2 \to \cdots \to X_n\) 构成一个马尔可夫链，则有
    ...
    - **证明**：
        ...
        &\therefore p(x_1,x_2,x_3,x_4)p(x_3) = p(x_1,x_2,x_3)p(x_3,x_3)\\
...
- **证明**:
    定义随机变量 \(Z = \begin{cases}0, & 若 X = \hat{X} \\ 1, & 若 X \neq \hat{X} \end{cases}\) ，则 \(P_r(Z) = \begin{cases}1 - P_e, & 若 Z = 0 \\ P_e, & 若 X = 1 \end{cases}\)，则\(H(Z)=H(P_e, 1 - P_e)=H(P_e)\)
